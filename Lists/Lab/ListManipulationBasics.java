    ...
    public static void main(String[] args) {
        ...
        while (!command.equals("end")) {
            ...
            if (command.contains("Add")) {
                ...
                int elementToInsertNum = Integer.parseInt(commandParts[1]);
                int elementToInsertIndex = Integer.parseInt(commandParts[2]);
                numbers.add(elementToInsertIndex, elementToInsertNum);
            }
